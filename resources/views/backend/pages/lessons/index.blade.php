                            ...
                            @isset($data['lessons'])
                                @foreach($data['lessons'] as $lesson)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-primary btn-md" data-effect="effect-just-me" data-toggle="modal"
                                               href="#show_video{{ $lesson->slug }}">Show Video</a>
                                        </td>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-primary btn-sm" data-effect="effect-just-me" data-toggle="modal"
                                               href="#edit{{ $lesson->slug }}">Edit</a>
                                            <a class="modal-effect btn btn-danger btn-sm" data-effect="effect-just-me" data-toggle="modal"
                                               href="#delete{{ $lesson->slug }}">Delete</a>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Show Video</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                    ...
                                    <div class="modal" id="edit{{ $lesson->slug }}">
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Edit Lesson</h6><button aria-label="Close" class="close"
                                                                                                      data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <form action="{{ route('teacher.lessons.update', $lesson->slug) }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="title" id="" value="{{ $lesson->title }}"
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="" class="form-label">Time Video<span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" name="time_video" id="" min="0" value="{{ $lesson->time_video }}"
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="" class="form-label">Selected Course<span
                                                                    class="text-danger">*</span></label>
                                                            <select name="course_id" id="course_id" class="form-control @error('course_id') is-invalid
                                                                @enderror">
                                                                <option selected disabled>Select Course</option>
                                                                @isset($data['courses'])
                                                                    @foreach($data['courses'] as $course)
                                                                        <option value="{{$course->id}}" {{ $course->id == $lesson->course->id ? 'selected' : "" }}>{{ $course->course_name }}</option>
                                                                    @endforeach
                                                                @endisset
                                                            </select>
                                                            @error('course_id')
                                    ...
                                    <div class="modal" id="delete{{ $lesson->slug }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Delete Lesson</h6><button aria-label="Close" class="close"
                                                                                                      data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <form action="{{ route('teacher.lessons.destroy', $lesson->slug) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            <p class="text-danger" style="font-size: 20px">Are You Sure Delete Lesson</p>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
